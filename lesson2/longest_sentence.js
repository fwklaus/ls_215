// determine the sentence with the most words in some text
  // sentences end with: [. ! ?]
  // sentences always begin with a word character \w
  // treat any sequence of characters that are not spaces or sentence-ending characters as a word
  // log the longest senten ce and its word count to the console

// problem is about manipulating and processing strings
// case-sensitive, punctuation, tabs, spaces, etc. all matter
